      ...
      <div className="bio m-2 h-75 justify-content-center mb-5">
        <Card className="d-flex border border-3">
          ...
          <ListGroup variant="flush">
            ...
            <ListGroup.Item>
              <div className="lh-1">
                I started the DU Full Stack coding bootcamp at the end of July,
                2022. It was time for me to make a career move and coding seemed
                like the best option. It's been tough and I've had to put a lot
                of extra time in to make sure I was happy with my progression
                but I'm truly happy with what I've learned the 7 weeks I've been
                in this course. Im Looking forward to joining a team that will
                encourage and push me to grow.
              </div>
            </ListGroup.Item>
          </ListGroup>
        </Card>
